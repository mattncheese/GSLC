    ...
    @section('content')
        <div class="about_section bg-rose-900 flex">
            <div class="about_section_content text-white flex items-center justify-center">
                ...
                <div class="dreamjob bg-white" style="margin-right:2vw">
                    <a href="https://en.wikipedia.org/wiki/Celebrity"> <h1 class="textmatt text-rose-900 font-serif font-light">Dream Job</h1>
                </div>
            </div>
            <div class="foto">
