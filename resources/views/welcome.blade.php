    ...
    @section('content')
        <div class="about_section bg-slate-900 flex">
            <div class="about_section_content text-white flex items-center justify-center">
                ...
                <div class="dreamjob bg-white" style="margin-right:3.5vw">
                    <a href="https://en.wikipedia.org/wiki/Surgeon"> <h1 class="textmatt text-slate-900 font-serif font-light">Dream Job</h1>
                </div>
            </div>
            <div class="foto">
