    ...
    @section('content')
        <div class="about_section bg-lime-700 flex">
            <div class="about_section_content text-white flex items-center justify-center">
                ...
                <div class="dreamjob bg-white" style="margin-right:2.5vw">
                    <a href="https://en.wikipedia.org/wiki/Businessperson"> <h1 class="textmatt text-lime-700 font-serif font-light">Dream Job</h1>
                </div>
            </div>
            <div class="foto">
