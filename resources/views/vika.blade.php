    ...
    @section('content')
        <div class="about_section bg-gray-900 flex">
            <div class="about_section_content text-white flex items-center justify-center">
                ...
                <div class="dreamjob bg-white" style="margin-right:7.5vw">
                    <a href="https://en.wikipedia.org/wiki/Chef_de_cuisine"> <h1 class="textmatt text-gray-900 font-serif font-light">Dream Job</h1>
                </div>
            </div>
            <div class="foto">
